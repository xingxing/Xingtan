...
describe TopicsController do
  ...
  describe "GET index" do
    it "assigns all topics as @topics" do
      Topic.stub(:find).with(:all).and_return([mock_topic])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested topic as @topic" do
      Topic.stub(:find).with("37").and_return(mock_topic)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new topic as @topic" do
      Topic.stub(:new).and_return(mock_topic)
      get :new
      assigns[:topic].should equal(mock_topic)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created topic as @topic" do
        Topic.stub(:new).with({'these' => 'params'}).and_return(mock_topic(:save => true))
